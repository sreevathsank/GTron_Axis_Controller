/* 
 * File:   TMC2209_HW_Abstraction.h
 * Author: sreevathsank
 *
 * Created on 24 September, 2025, 11:25 AM
 */

#ifndef TMC2209_HW_ABSTRACTION_H
#define	TMC2209_HW_ABSTRACTION_H
...
#define TMC2209_VACTUAL_MASK                 0xFFFFFF // VACTUAL // VACTUAL allows moving the motor by UART control. It gives the motor velocity in +-(2^23)-1 [?steps / t] 0: Normal operation. Driver reacts to STEP input. /=0:  Motor  moves  with  the  velocity  given  by  VACTUAL.  Step  pulses  can  be  monitored  via  INDEX  output.  The  motor  direction is controlled by the sign of VACTUAL.
...
#endif	/* TMC2209_HW_ABSTRACTION_H */
