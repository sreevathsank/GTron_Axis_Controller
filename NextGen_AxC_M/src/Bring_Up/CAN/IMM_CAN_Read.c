...
//			do_Move_Done_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " MOVE_DONE_PING_X\n");
//		break;
//		case PING_X:
//			do_4671_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " PING_X\n");
//		break;
//		case REF_SEARCH_PING_X:
//		{
//			rfs_ping_rxvd = true;
//			do_Ref_Search_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " REF_SEARCH_PING_X\n");	
//			break;
//		}
//		case MAX_ACCEL_X:
//		case MAX_DECCEL_X:
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Common_X\n");
//		break;
//		case MAX_POSITION_SPEED_X:
//			speed = decoding_CAN_Byte_Data();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Speed = %ld ", speed);
...
//			}
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Speed rpm = %ld ", speed);
//			reply_MCD_Common(REPLY_ID_X, X, 0x64, SAP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Max_Pos_Speed_X");
//		break;
//		case RFS_START_X:
...
//				do_homing_sequence();
//			}
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " RFS_START_X\n");
...
//			homing_v = 0;
//			timer_stop(&TIMER_0);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " RFS_STOP_X\n");
//			reply_MCD_Common(REPLY_ID_X, X, 0x64, RFS);
//			break;
//		}
//		case MOVE_TO_X:
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " | X Move To | %ld steps or %.2f mm\n", value, (value / TMC4671_ONE_MM_STEPS) );
//		break;
//		case MOVE_BY_X:
//			check_move_done = true;
//			value = decoding_CAN_Byte_Data();
...
//			encoding_CAN_Byte_Data(value);
//			reply_MCD_Common(REPLY_ID_X, X, 0x64, MVP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " | X Move By | %ld steps or %.2f mm\n", value, (value / TMC4671_ONE_MM_STEPS) );
//		break;
//		case STOP_MOTION_X:
//			tmc4671_setVelocityLimit(MOTOR, 0);
//			tmc4671_setModeMotion(MOTOR, STOPPED_MODE);
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " MOTOR_STOP_X\n");
//		break;
//		case ROTARY_ENC_X:
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Target Position Y %ld", target_position);
//		break;
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " LINEAR_ENC_CLEAR_X\n");
//		break;
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " LINEAR_ENC_READ_X | %ld usteps | %.2f mm\n", x_enc_count, (x_enc_count / (x_linear_enc_res / IMM_PITCH_MM)) );
//		break;
...
//				//vel_struct.prev_lin_enc_val = 0;
//			}
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " KNOB_MODE_X | %d\n", knob_dis_enable);
//		break;
...
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "READ_PARAMETER_FLASH_X - Tag = %d (or) 0x%x | Length = %d or 0x%x | Data = %ld | 0x%x \n",\
...
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "WRITE_PARAMETER_FLASH_X - Tag = %d (or) 0x%x | Length = %d or 0x%x | Data = %ld | 0x%x \n",\
...
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "CHECK_PARAMETER_FLASH_X\n");
//				break;
//			}
//			default: break;
//		}
...
//			do_Move_Done_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " MOVE_DONE_PING_Y\n");
//		break;
//		case PING_Y:
//			do_4671_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " PING_Y\n");
//		break;
//		case REF_SEARCH_PING_Y:
//			do_Ref_Search_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " REF_SEARCH_PING_Y\n");
//		break;
//		case MAX_ACCEL_Y:
//		case MAX_DECCEL_Y:
...
//			reply_MCD_Common(REPLY_ID_Y, Y_ADDR, 0x64, SAP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Common_Y\n");
//		break;
//		case MAX_POSITION_SPEED_Y:
//			speed = decoding_CAN_Byte_Data();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Speed = %d ", speed);
//			speed = (int32_t) convert_PPS_To_RPM(speed);
//			
//			// Checking if the motor is moving
//			if( move_given_trapezoidal_ramp == false || move_given_s_ramp == false ) 
...
//				velocity_limit = speed;
//			}
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Speed rpm = %d ", speed);
//			reply_MCD_Common(REPLY_ID_Y, Y_ADDR, 0x64, SAP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Max_Pos_Speed_Y");
//		break;
//		case RFS_START_Y:
//			limit_variables.homing = true;
//			velocity_limit = 0;
...
//			}
//			
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " RFS_START_Y\n");
//			reply_MCD_Common(REPLY_ID_Y, Y_ADDR, 0x64, RFS);
//		break;
//		case RFS_STOP_Y:
//		{
//			tmc4671_setVelocityLimit(MOTOR, 0);
...
//			homing_v = 0;
//			timer_stop(&TIMER_0);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " RFS_STOP_Y\n");
//			reply_MCD_Common(REPLY_ID_Y, Y_ADDR, 0x64, RFS);
//			break;
//		}
//		case MOVE_TO_Y:
...
//							move_With_S_Ramp(value, velocity_limit, MOVE_TO);
//			encoding_CAN_Byte_Data(value);
//			reply_MCD_Common(REPLY_ID_Y, Y_ADDR, 0x64, MVP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " | Y Move To | %ld steps or %.2f mm\n", value, (value / TMC4671_ONE_MM_STEPS) );
//		break;
//		case MOVE_BY_Y:
//			check_move_done = true;
//			value = decoding_CAN_Byte_Data();
...
//			encoding_CAN_Byte_Data(value);
//			reply_MCD_Common(REPLY_ID_Y, Y_ADDR, 0x64, MVP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " | Y Move By | %ld steps or %.2f mm\n", value, (value / TMC4671_ONE_MM_STEPS) );
//		break;
//		case STOP_MOTION_Y:
//			tmc4671_setVelocityLimit(MOTOR, 0);
//			tmc4671_setModeMotion(MOTOR, STOPPED_MODE);
...
//			homing_v = 0;
//			timer_stop(&TIMER_0);
//			reply_MCD_Common(REPLY_ID_Y, Y_ADDR, 0x64, MST);
//		break;
//		case ROTARY_ENC_Y: {
//			message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, GAP);
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "\nad %x  cmd %x  typ %x mot %x Data %x %x %x %x %x", ad, cmd, typ ,mot,can_tx_frame.data[0], can_tx_frame.data[1], can_tx_frame.data[2], can_tx_frame.data[3], can_rx_frame.data[4]);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Rotary Encoder Count = %ld ROTARY_ENC_Y\n", current_position); }
//		break;
//		case TARGET_POSITION_Y:
//			message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, SAP);
//			int32_t target_position; //= decoding_Byte_Data();
//			target_position = tmc4671_getTargetPosition(target_position);
//			encoding_CAN_Byte_Data(target_position);
//			can_Write(message_Id, target_position);
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " LINEAR_ENC_CLEAR_Y\n");
//		break;
//		case LINEAR_ENC_READ_Y:
//			// Read and Send the Linear Encoder value on the CAN bus.
//			message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, LIN_ENC_READ);
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "\nad %x  cmd %x  typ %x mot %x Data %x %x %x %x %x", ad, cmd, typ ,mot,can_tx_frame.data[0], can_tx_frame.data[1], can_tx_frame.data[2], can_tx_frame.data[3], can_rx_frame.data[4]);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " LINEAR_ENC_READ_Y | %ld usteps | %.2f mm\n", y_enc_count, (y_enc_count / (y_linear_enc_res / IMM_PITCH_MM)) );
//		break;
//		case RT_LIM_SW_CHECK_Y: {
//			// Right Limit Switch Status reply for Homing (Diagnostic Tool).
//			message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, 0x0A);
//			int32_t rt_limit_state;
//			//rt_limit_state = (int32_t) gpio_get_pin_level(LIM_RT);
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "\nad %x  cmd %x  typ %x mot %x Data %x %x %x %x %x", ad, cmd, typ ,mot,can_tx_frame.data[0], can_tx_frame.data[1], can_tx_frame.data[2], can_tx_frame.data[3], can_rx_frame.data[4]); 
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " state = %d RT_LIM_SW_CHECK_Y\n", gpio_get_pin_level(LIM_RT)); }
//		break;
//		case LFT_LIM_SW_CHECK_Y: {
//			// Left Limit Switch Status reply for Homing (Diagnostic Tool).
//			message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, 0x0B);
//			int32_t lft_limit_state;
//			lft_limit_state = (int32_t) gpio_get_pin_level(LIM_LFT);
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "\nad %x  cmd %x  typ %x mot %x Data %x %x %x %x %x", ad, cmd, typ ,mot,can_tx_frame.data[0], can_tx_frame.data[1], can_tx_frame.data[2], can_tx_frame.data[3], can_rx_frame.data[4]);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " state = %d LFT_LIM_SW_CHECK_Y\n", gpio_get_pin_level(LIM_LFT)); }
//		break;
...
//				//vel_struct.prev_lin_enc_val = 0;
//			}
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " KNOB_MODE_Y | %d\n", knob_dis_enable);
//		break;
...
//				}
//			}
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " KNOB_MOVEMENT_Y SPEED = %d | Direction = %d\n", velocity_x, vel_struct.flags.direction);
//		break;
...
//			case WR_MC:
//			{
//				message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, WR_MC);
//				int32_t wr_reg_data = decoding_CAN_Byte_Data();
//				tmc4671_writeInt(MOTOR, typ, wr_reg_data);
//				encoding_CAN_Byte_Data(wr_reg_data);
//				can_Write(message_Id, wr_reg_data);
...
//			case RD_MC:
//			{
//				message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, RD_MC);
//				int32_t rd_reg_data = tmc4671_readInt(MOTOR, typ);
//				encoding_CAN_Byte_Data(rd_reg_data);
//				can_Write(message_Id, rd_reg_data);
//				break;
...
//				read_tlv_flash(tlv_ptr, parameter_id, tlv_traversal);
//				encoding_CAN_Byte_Data(tlv_ptr->value_32bit);
//				message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, RD_FW_PARAM);
//				can_tx_frame.data[4] = can_Message_Calculate_Crc(message_Id, tlv_ptr->value_32bit);
//				can_Write(message_Id, tlv_ptr->value_32bit);
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "READ_PARAMETER_FLASH_Y - Tag = %d (or) 0x%x | Length = %d or 0x%x | Data = %ld | 0x%x \n",\
//				tlv_ptr->tag, tlv_ptr->tag, tlv_ptr->length, tlv_ptr->length, tlv_ptr->value_32bit, tlv_ptr->value_32bit);
//				break;
//			}
//			case WR_FW_PARAM:
...
//				
//				write_tlv_flash(parameter_id, &parameter_val, parameter_len);
//				message_Id = CAN_ID(REPLY_ID_Y, Y_ADDR, 0x64, WR_FW_PARAM);
//				encoding_CAN_Byte_Data(parameter_val);
//				can_tx_frame.data[4] = can_Message_Calculate_Crc(message_Id, parameter_val);
//				can_Write(message_Id, parameter_val);
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "WRITE_PARAMETER_FLASH_Y - Tag = %d (or) 0x%x | Length = %d or 0x%x | Data = %ld | 0x%x \n",\
//										parameter_id, parameter_id, parameter_len, parameter_len, parameter_val, parameter_val);
//				break;
//			}
//			case CHK_FW_PARAM:
...
//				int32_t value_check = decoding_CAN_Byte_Data();
//				check_tlv_param(tlv_ptr, parameter_id, tlv_traversal, value_check);
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "CHECK_PARAMETER_FLASH_Y\n");
//				break;
//			}
//			default: break;
//		}
...
//			do_Move_Done_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " MOVE_DONE_PING_Z\n");
//		break;
//		case PING_Z:
//			do_4671_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " PING_Z\n");
//		break;
//		case REF_SEARCH_PING_Z:
//			do_Ref_Search_Ping();
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " REF_SEARCH_PING_Z\n");
//		break;
//		case MAX_ACCEL_Z:
//		case MAX_DECCEL_Z:
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Common_Z\n");
//		break;
//		case ENABLE_SOFT_LIMITS_Z:
//			reply_MCD_Common(REPLY_ID_Z, Z, 0X64, SAP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " EN Soft Limits_Z\n");
//		break;
...
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " AF Temp Vel set to %ld rpm |", autofocus_variables.temp_t_vel);
//			}
//			reply_MCD_Common(REPLY_ID_Z, Z, 0x64, SAP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Max_Pos_Speed_Z");
//		break;
//		case RFS_START_Z:
...
//				tmc4671_writeInt(MOTOR, TMC4671_ABN_2_DECODER_MODE, (linear_enc_dir | 256) );
//			}
//			limit_variables.homing = true;
//			velocity_limit = 0;
//			while(tmc4671_getVelocityLimit(MOTOR) != 0x00)
...
//				}
//			}
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " REF_SEARCH_Z\n");
...
//			homing_v = 0;
//			//timer_stop(&TIMER_0);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " RFS_STOP_Z\n");
//			reply_MCD_Common(REPLY_ID_Z, Z, 0x64, RFS);
//			break;
//		}
//		case MOVE_TO_Z:
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " | Z Move To | %ld steps or %.2f mm\n", value, (value / TMC4671_ONE_MM_STEPS) );
//		break;
//		case MOVE_BY_Z:
//			check_move_done = true;
//			value = decoding_CAN_Byte_Data();
...
//			encoding_CAN_Byte_Data(value);
//			reply_MCD_Common(REPLY_ID_Z, Z, 0x64, MVP);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " | Z Move By | %ld steps or %.2f mm\n", value, (value / TMC4671_ONE_MM_STEPS) );
//		break;
//		case STOP_MOTION_Z:
//			tmc4671_setVelocityLimit(MOTOR, 0);
//			tmc4671_setModeMotion(MOTOR, STOPPED_MODE);
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG,  " MST_Z\n");
//		break;
//		case ROTARY_ENC_Z:
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Rot ENc_Z\n");
//		break;
...
//			encoding_CAN_Byte_Data(actual_position);
//			can_Write(message_Id, actual_position);
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " Actual Pos_Z\n");
//		break;
//		case AF_STARTPOINT:
...
//				}
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "  | AF_STARTPOINT_Z (-)spAF \n");
//			}
//			else
//			{
//				for(int32_t i = 1; i < AUTOFOCUS_INDEX_LENGTH; i++)
...
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " LIN_ENC_CLR_Z\n");
//		break;
...
//			// Right Limit Switch Status reply for Homing (Diagnostic Tool).
//			int32_t rt_limit_state;
//			rt_limit_state = (int32_t) LIM_RT_Get();
//			encoding_CAN_Byte_Data(rt_limit_state);
//			reply_MCD_Common(REPLY_ID_Z, Z_ADDR, 0x64, 0x0A); }
//		break;
//		case LFT_LIM_SW_CHECK_Z: {
//			// Left Limit Switch Status reply for Homing (Diagnostic Tool).
//			int32_t lft_limit_state;
//			lft_limit_state = (int32_t) LIM_LFT_Get();
//			encoding_CAN_Byte_Data(lft_limit_state);
//			reply_MCD_Common(REPLY_ID_Z, Z_ADDR, 0x64, 0x0B); }
//		break;
...
//				//vel_struct.prev_lin_enc_val = 0;
//			}
//			SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, " KNOB_MODE_Z | %d\n", knob_dis_enable);
//		break;
...
//			// If Left Limit hit, don't move if the given velocity is anti clockwise.( -ve velocity)
//			// If Right Limit hit, don't move if the given velocity is clockwise.(+ve velocity)
//			if( ( LIM_LFT_Get() == LOW ) && ( vel_struct.flags.direction == false ) || \
//			( LIM_RT_Get()  == LOW ) && ( vel_struct.flags.direction == true ) )
//			{
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "\n#-----Can't move beyond the Limit! Vel Mode-----#\n");
//				return;
//			}
...
//				can_tx_frame.data[4] = can_Message_Calculate_Crc(message_Id, tlv_ptr->value_32bit);
//				can_Write(message_Id, tlv_ptr->value_32bit);
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "READ_PARAMETER_FLASH_Z - Tag = %d (or) 0x%x | Length = %d or 0x%x | Data = %ld | 0x%x \n",\
//				tlv_ptr->tag, tlv_ptr->tag, tlv_ptr->length, tlv_ptr->length, tlv_ptr->value_32bit, tlv_ptr->value_32bit);
//				break;
//			}
//			case WR_FW_PARAM:
...
//				can_tx_frame.data[4] = can_Message_Calculate_Crc(message_Id, parameter_val);
//				can_Write(message_Id, parameter_val);
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "WRITE_PARAMETER_FLASH_Z - Tag = %d (or) 0x%x | Length = %d or 0x%x | Data = %ld | 0x%x \n",\
//				parameter_id, parameter_id, parameter_len, parameter_len, parameter_val, parameter_val);
//				break;
//			}
//			case CHK_FW_PARAM:
...
//				int32_t value_check = decoding_CAN_Byte_Data();
//				check_tlv_param(tlv_ptr, parameter_id, tlv_traversal, value_check);
//				SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "CHECK_PARAMETER_FLASH_Z\n");
//				break;
//			}
//			default: break;
//		}
...
void can_Message_Decode(uint32_t message_Id, int32_t data)
{
	...
	switch(axis_id)
	{
		...
		break;
		case GTRON_AXC_BOT:
			//SYS_DEBUG_PRINT(SYS_ERROR_DEBUG, "\nReceived by AxC_Bot: %lx Data %x %x %x %x %x", message_Id, can_rx_frame.data[0], can_rx_frame.data[1], can_rx_frame.data[2], can_rx_frame.data[3], can_rx_frame.data[4]);
			can_Message_Process_GTron_Message_Data();
		break;
		default: break;
	}
